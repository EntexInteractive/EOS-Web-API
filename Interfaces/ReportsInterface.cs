...
namespace EpicGames.Web.Interfaces
{
    ...
    public class ReportsInterface(string accessToken, string url = "https://api.epicgames.dev")
    {
        ...
        /// </summary>
        /// <param name="deploymentId">The EOS deploymentId. It has to match the deploymentId generated by the access token.</param>
        ...
        /// </summary>
        /// <param name="deploymentId">The EOS deploymentId. It has to match the deploymentId generated by the access token.</param>
        /// <param name="reportedPlayerId">The reported EOS productUserId.</param>
        /// <returns>An array of found <see cref="Report"/>s.</returns>
